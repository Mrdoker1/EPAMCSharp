...
namespace CountingArrayElements
{
    public static class WhileMethods
    {
        ...
        public static int GetEmptyStringCount(string[] arrayToSearch)
        {
            ...
            while (true)
            {
                if (counter < arrayToSearch.Length)
                {
                    if (string.IsNullOrEmpty(arrayToSearch[counter]))
                    {
                        result++;
                    }
                }
        ...
        public static int GetMinOrMaxLongCount(long[] arrayToSearch)
        {
            ...
            while (true)
            {
                if (counter < arrayToSearch.Length)
                {
                    if (arrayToSearch[counter] == long.MaxValue || arrayToSearch[counter] == long.MinValue)
                    {
                        result++;
                    }
                }
